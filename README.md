This project showcases a collection of applied AI tools developed using large language models (LLMs) for real-world document and customer service automation tasks.  
